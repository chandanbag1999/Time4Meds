...
export default function Navbar({ isMobile = false, isMenuOpen = false, toggleMenu }: NavbarProps) {
  ...
  return (
    <nav className={cn(
      ...
      <Container className="py-3" size={isMobile ? "lg" : "2xl"}>
        <div className="flex items-center justify-between w-full">
          {/* Logo and Mobile Menu Button */}
          <div className="flex items-center">
            <Link to="/dashboard" className="font-bold text-xl text-primary-500 mr-4">
              MediRemind
            </Link>
      ...
      {isMobile && isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-white border-b border-gray-200 shadow-lg z-50 animate-fadeIn">
